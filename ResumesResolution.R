...
df$outcome_tri_w0 <- factor(df$outcome_tri_w0, levels = c("Ongoing", "Agreement", "Ceasefire", "Gov. Victory", "Reb. Victory", "Low Activity/Cease to Exist"))
...
# Figure 2
ame <- avg_slopes(h1, newdata = "mean", variables = c("negotiationskill_avg"))
# library(dplyr)
